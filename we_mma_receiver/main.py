...
使用方式：
    ...
    # Headless 模式（無 GUI）
    python -m we_mma_receiver.main --headless
    python we_mma_receiver/main.py --headless
    
    # 作為模組導入
    from we_mma_receiver.core import ReceiverCore
    core = ReceiverCore()
    core.start()
"""
...
if __name__ == "__main__" or __package__ is None:
    ...
    from we_mma_receiver.core import (PersonActionInfo, ReceiverCore,
                                      ReceiverStatus)
else:
...
def run_headless():
    ...
    """
    print("=" * 50)
    print("  WE_MMA_Receiver - Headless Mode")
    print("=" * 50)
    print()
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="WE_MMA_Receiver - 骨架資料網路接收端",
