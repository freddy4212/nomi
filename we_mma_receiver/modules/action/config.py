...
def _resolve_model_path_internal(relative_path: str) -> str:
    ...
    # 1. 優先嘗試在模組內部的 models/ 目錄下尋找 (we_mma_receiver/modules/action/models/)
    ...
    # 2. 嘗試在 we_mma_receiver/ 目錄下尋找 (針對 submodule)
    base_dir = action_module_dir.parent.parent  # we_mma_receiver/
