...
使用方式：
    # GUI 模式（預設）
    python -m home_agent_memory.main
    python home_agent_memory/main.py
    
    # Headless 模式（無 GUI）
    python -m home_agent_memory.main --headless
    python home_agent_memory/main.py --headless
    
    # 作為模組導入
    from home_agent_memory.core import MemoryCore
    core = MemoryCore()
    core.start()
"""
import argparse
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Home Agent Memory Layer - 記憶層服務",
