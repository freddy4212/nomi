...
/* 1280x720 30fps configuration */
static const struct imx219_reg imx219_1280x720_regs[] = {
    /* Stream off */
    {0x0100, 0x00},
    /* Clock settings */
    {0x0114, 0x01}, /* CSI_LANE_MODE */
    ...
    {0x016E, 0x02}, /* Y_OUTPUT_SIZE_MSB */
    {0x016F, 0xD0}, /* Y_OUTPUT_SIZE_LSB (720) */
    /* Binning settings */
    {0x0170, 0x01}, /* X_ODD_INC_A */
    {0x0171, 0x01}, /* Y_ODD_INC_A */
...
/* 1920x1080 15fps configuration */
static const struct imx219_reg imx219_1920x1080_regs[] = {
    /* Stream off */
    {0x0100, 0x00},
    /* Clock settings */
    {0x0114, 0x01}, /* CSI_LANE_MODE */
    ...
    {0x016E, 0x04}, /* Y_OUTPUT_SIZE_MSB */
    {0x016F, 0x38}, /* Y_OUTPUT_SIZE_LSB (1080) */
    /* Binning settings */
    {0x0170, 0x01}, /* X_ODD_INC_A */
    {0x0171, 0x01}, /* Y_ODD_INC_A */
    {0x0174, 0x00}, /* BINNING_MODE_H_A */
...
/* 3280x2464 15fps configuration */
static const struct imx219_reg imx219_3280x2464_regs[] = {
    /* Stream off */
    {0x0100, 0x00},
    /* Clock settings */
    {0x0114, 0x01}, /* CSI_LANE_MODE */
    ...
    /* Frame timing */
    {0x0157, 0x00}, /* ANALOG_GAIN_GLOBAL */
    {0x0160, 0x09}, /* FRM_LENGTH_A_MSB */
    {0x0161, 0xC7}, /* FRM_LENGTH_A_LSB */
    {0x0162, 0x0D}, /* LINE_LENGTH_A_MSB */
    {0x0163, 0x78}, /* LINE_LENGTH_A_LSB */
    /* Crop settings - full sensor */
    {0x0164, 0x00}, /* X_ADD_STA_A_MSB */
    {0x0165, 0x00}, /* X_ADD_STA_A_LSB */
    {0x0166, 0x0C}, /* X_ADD_END_A_MSB */
    {0x0167, 0xCF}, /* X_ADD_END_A_LSB */
    {0x0168, 0x00}, /* Y_ADD_STA_A_MSB */
    {0x0169, 0x00}, /* Y_ADD_STA_A_LSB */
    {0x016A, 0x09}, /* Y_ADD_END_A_MSB */
    {0x016B, 0x9F}, /* Y_ADD_END_A_LSB */
    /* Output size */
    {0x016C, 0x0C}, /* X_OUTPUT_SIZE_MSB */
    {0x016D, 0xD0}, /* X_OUTPUT_SIZE_LSB (3280) */
    {0x016E, 0x09}, /* Y_OUTPUT_SIZE_MSB */
    {0x016F, 0xA0}, /* Y_OUTPUT_SIZE_LSB (2464) */
    /* Binning settings */
    {0x0170, 0x01}, /* X_ODD_INC_A */
    {0x0171, 0x01}, /* Y_ODD_INC_A */
    {0x0174, 0x00}, /* BINNING_MODE_H_A */
