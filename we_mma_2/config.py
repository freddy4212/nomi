...
class SimplifiedActionConfig:
    ...
    mapping: Dict[int, int] = field(default_factory=lambda: {
        ...
        24: 1, 31: 1, 34: 1, 35: 1, 36: 1, 39: 1, 53: 1, 54: 1, 55: 1, 56: 1, 57: 1,
        ...
        # === 靜止/等待 (9) ===
        0: 9, 1: 9, 2: 9, 3: 9, 12: 9, 27: 9, 30: 9, 37: 9, 38: 9,
...
class MotionConfig:
    ...
    threshold_low: float = 10.0   # 提高閾值以減少抖動誤判
    threshold_high: float = 30.0  # 高於此為劇烈
